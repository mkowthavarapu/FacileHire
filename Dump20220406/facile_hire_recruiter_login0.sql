...
CREATE TABLE `recruiter_login` (
  `recuriter_login_id` int NOT NULL,
  `user_name` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL,
  `created_date` datetime DEFAULT CURRENT_TIMESTAMP,
  `modified_date` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`recuriter_login_id`)
...
INSERT INTO `recruiter_login` VALUES (1,'manohar@gmail.com','manohar123','2022-04-05 23:48:16',NULL);
...
-- Dump completed on 2022-04-12  1:38:13
