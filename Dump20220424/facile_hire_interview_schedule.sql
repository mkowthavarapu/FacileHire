...
CREATE TABLE `interview_schedule` (
  ...
  `schedule_interview` date DEFAULT NULL,
  `interview_scheduled` tinyint(1) DEFAULT NULL,
  `not_attended_interview` tinyint(1) DEFAULT NULL,
...
-- Dump completed on 2022-04-24 21:23:29
